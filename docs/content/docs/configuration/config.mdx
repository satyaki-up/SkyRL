...
algorithm:
  ...
  kl_estimator_type: "k3" # "k1", "k2", "k3", "abs", "js" - see http://joschu.net/blog/kl-approx.html for KL estimator details
...
- `algorithm.kl_estimator_type`: KL/divergence estimator type to use. Options include: `k1`, `k2`, `k3`, `abs`, `js`. See [this blog post](http://joschu.net/blog/kl-approx.html) for KL estimator details. We use `k3` as the default.
